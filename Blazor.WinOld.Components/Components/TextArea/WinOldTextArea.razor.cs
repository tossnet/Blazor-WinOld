...
public partial class WinOldTextArea : WinOldComponentBase, IAsyncDisposable
{
    [Inject]
    ...
    /// <summary>
    /// Optional in-line styles applied to the textarea element specifically.
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// Sets focus on the textarea and selects its entire content, so typing immediately replaces it.
    /// </summary>
    ...
    private string GetComponentClass()
    {
        ...
        {
            Appearance.Win98 => "txtarea-win-98",
            Appearance.WinXP => "txtarea-win-xp",
            Appearance.Win7 => "txtarea-win-7",
            Appearance.Win10 => "txtarea-win-10",
            _ => "txtarea-win-10"
        };
