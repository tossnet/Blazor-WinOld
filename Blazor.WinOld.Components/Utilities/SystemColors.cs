...
public static class SystemColors
{
    ...
    public static Color Desktop
    {
        get
        {
            ...
            {
                Appearance.DOS => Color.FromArgb(1, 0, 168),      // #0100A8
                Appearance.Win31 => Color.FromArgb(192, 192, 192), // #C0C0C0
    ...
    public static Color TitleBar
    {
        get
        {
            return Appearance switch
            {
                Appearance.DOS => Color.FromArgb(176, 176, 176),  // #B0B0B0 (no distinct title bar in DOS: same as Form)
                Appearance.Win31 => Color.FromArgb(0, 0, 170),    // #0000AA
    ...
    public static Color Form
    {
        get
        {
            return Appearance switch
            {
                Appearance.DOS => Color.FromArgb(176, 176, 176),  // #B0B0B0
                Appearance.Win31 => Color.FromArgb(255, 255, 255), // #FFFFFF
